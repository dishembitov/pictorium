...
import ru.dishembitov.pictorium.board.BoardIndexService;
import ru.dishembitov.pictorium.kafka.event.BoardEvent;
import ru.dishembitov.pictorium.pin.PinIndexService;
...
public class ContentEventConsumer {
    ...
    @KafkaListener(
            ...
            properties = {"spring.json.value.default.type=event.kafka.ru.dishembitov.pictorium.ContentEvent"}
    )
